...
export function playSound(kind: SoundKind) {
  switch (kind) {
    ...
    case "capture":
      ...
      setTimeout(() => beep(140, 0.08, "square", 0.03), 40);
      break;
    case "check":
      beep(660, 0.1, "sawtooth", 0.03);
      setTimeout(() => beep(880, 0.12, "sawtooth", 0.025), 70);
      break;
    case "castle":
      beep(400, 0.08, "triangle");
      setTimeout(() => beep(520, 0.1, "triangle"), 60);
      break;
    case "promote":
      beep(523, 0.08);
    ...
    case "start":
      beep(392, 0.1);
      setTimeout(() => beep(523, 0.14), 90);
      break;
    case "end":
      beep(330, 0.2, "sine", 0.05);
      setTimeout(() => beep(247, 0.35, "sine", 0.04), 160);
      break;
    default: {
